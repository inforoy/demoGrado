...
<html lang="en">
    <head>
        ...
        <!-- fullCalendar -->
        <link type="text/css" rel="stylesheet" href="<c:url value="css/fullcalendar/fullcalendar.css" />" />
        <!-- Daterange picker -->
        <link type="text/css" rel="stylesheet" href="<c:url value="css/daterangepicker/daterangepicker-bs3.css" />" />
        <!-- bootstrap wysihtml5 - text editor -->
        <link type="text/css" rel="stylesheet" href="<c:url value="css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" />" />
        <!-- Theme style -->
        
<%--         <link type="text/css" rel="stylesheet" href="<c:url value="/css/AdminLTE.css" />" /> --%>
    ...
    <body class="skin-blue">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="pages/examples/personaNatural.html"><i class="fa fa-angle-double-right"></i> Registrar Persona Natural</a></li>
                                <li><a href="pages/examples/personaJuridica.html"><i class="fa fa-angle-double-right"></i> Registrar Persona Juridica</a></li>

                                <li><a href="pages/examples/y_registrarSocio.html"><i class="fa fa-angle-double-right"></i> Registrar Socio</a></li>
        ...
        <!-- jQuery UI 1.10.3 -->
        <c:url value="js/jquery-ui-1.10.3.min.js"/>
        <!-- Bootstrap -->
        <c:url value="js/bootstrap.min.js"/>
        <!-- Morris.js charts -->
        <script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
        <c:url value="js/plugins/morris/morris.min.js"/>
        <!-- Sparkline -->
        <c:url value="js/plugins/sparkline/jquery.sparkline.min.js"/>
        <!-- jvectormap -->
        <c:url value="js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"/>
        <c:url value="js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"/>
        <!-- fullCalendar -->
        <c:url value="js/plugins/fullcalendar/fullcalendar.min.js"/>
        <!-- jQuery Knob Chart -->
        <c:url value="js/plugins/jqueryKnob/jquery.knob.js"/>
        <!-- daterangepicker -->
        <c:url value="js/plugins/daterangepicker/daterangepicker.js"/>
        <!-- Bootstrap WYSIHTML5 -->
        <c:url value="js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"/>
        <!-- iCheck -->
        <c:url value="js/plugins/iCheck/icheck.min.js"/>

        <!-- AdminLTE App -->
        <c:url value="js/AdminLTE/app.js"/>
        <!-- AdminLTE dashboard demo (This is only for demo purposes) -->        
		<c:url value="js/AdminLTE/dashboard.js"/>
    </body>
</html>